...
function App() {
  ...
  const calc = () => {
    if (value.length >= 5 && value.slice(-1) !== " ") {
      if(value.indexOf('sin') || value.indexOf('cos') || value.indexOf('tan') || value.indexOf('log') || value.indexOf('ln') || value.indexOf('log') || value.indexOf('sqrt')){
        setValue(eval('Math.'+value).toString());
      }else{
    ...
    <>
      ...
      <Container>
        ...
        <ButtonContainer>
          ...
          <Button onClick={() => setValue(value + "sin(")} >sin</Button>
          <Button onClick={() => setValue(value + "cos(")} >cos</Button>
          <Button onClick={() => setValue(value + "tan(")} >tan</Button>
          <Button onClick={() => setValue(value + ")")} >)</Button>

          <Button onClick={() => setValue(value + "log(")} >ln</Button>
          <Button onClick={() => setValue(value + "log10(")} >log</Button>
          <Button onClick={() => setValue(value + "sqrt(")} >sqrt</Button>
          <Button onClick={() => setValue(value + "(")} >(</Button>
